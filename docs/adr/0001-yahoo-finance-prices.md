...
- [Research 02 — Yahoo batch endpoint](../research/02-yahoo-batch-endpoint.md) — original quote-endpoint research, now deprecated (see #05)
- [Research 05 — Yahoo chart endpoint](../research/05-chart-endpoint.md) — replacement endpoint (`/v8/finance/chart/<SYMBOL>`)
