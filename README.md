...
_Last updated at v1.16 close-out._ The remaining open items are in the per-version issue trackers under `.scratch/`:
...
- [docs/adr/](docs/adr/) — architectural decisions (0001–0023)
