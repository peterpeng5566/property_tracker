...
(function (root) {
  ...
  const api = { buildBackupSnapshot, buildMultipartBody, pushBackup, restoreFromBackup, restoreFromSnapshot, writePortfolioBackupFile, readPortfolioBackupFile, listPortfolioBackupFiles, cleanupOldBackups, parseBackupFilename };
