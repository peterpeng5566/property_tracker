...
(function (root) {
  ...
  const api = { buildBackupSnapshot, pushBackup, restoreFromBackup, restoreFromSnapshot, writePortfolioBackupFile, readPortfolioBackupFile, listPortfolioBackupFiles, cleanupOldBackups };
