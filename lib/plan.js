  ...
  function driftForRule(rule, records, recordsAttributes, fxRate, netWorth) {
    ...
    if (matchingTotal === 0) {
      if (hasNetWorth) {
        ...
        return { matching_total: 0, actual: {}, target, drift: {}, rule_target_amount: ruleTargetAmount, target_amount: targetAmount, actual_amount: actualAmount, drift_amount: driftAmount };
      }
      return { matching_total: 0, actual: {}, target, drift: {} };
    }
    ...
    if (filteredTotal === 0) {
      ...
      if (hasNetWorth) {
        return { matching_total: matchingTotal, actual, target, drift, rule_target_amount: ruleTargetAmount, target_amount: targetAmount, actual_amount: actualAmount, drift_amount: driftAmount };
      }
